...
beautiful.init(theme_dir .. "dark.lua")
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_normal_width,
...
client.add_signal("focus", function(c)
        c.border_width = beautiful.border_focused_width
        c.border_color = beautiful.border_focus
        -- c.opacity = beautiful.opacity_focused
    end)
client.add_signal("unfocus", function(c)
        c.border_width = beautiful.border_normal_width
        c.border_color = beautiful.border_normal
        -- c.opacity = beautiful.opacity_normal
    end)
-- }}}

awful.util.spawn_with_shell(scripts_dir .. "autostart.sh")
